                        ...
                        <form method="POST" action="/users" enctype="multipart/form-data">
                            ...
                            <div class="row clearfix mb-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a class="image-file-input" href="javascript:;"><img id="avatar_preview" class="rounded-circle img-raised" src="/images/avatar.png" style="max-width:150px;"><i class="material-icons">camera_enhance</i></a>
                                    </div>
                                </div>
                                <div class="col-md-4"></div>
                            </div>
