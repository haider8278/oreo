        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-12">
                    <h2>Dashboard <small class="text-muted">Welcome to Oreo</small></h2>
                </div>
                <div class="col-lg-7 col-md-7 col-sm-12 text-right">
                    ...
                    <ul class="breadcrumb float-md-right">
                        <li class="breadcrumb-item"><a
                                href="https://thememakker.com/templates/oreo/hospital/laravel/public/dashboard/index"><i
                                    class="zmdi zmdi-home"></i> Oreo</a></li>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table m-b-0 table-hover">
                                            <thead>
                                                <tr>
                                                    <th>Name</th>
                                                    <th class="d-none d-md-inline-block">Address</th>
                                                    <th>Earning</th>
                                                    <th class="d-none d-lg-inline-block">Reviews</th>
                                                    <th></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td>Hospital Name</td>
                                                    <td class="d-none d-md-inline-block">Porterfield 508 Virginia Street
                                                        Chicago, IL 60653</td>
                                                    <td>$2,325</td>
                                                ...
                                                <tr>
                                                    <td>Hospital Name</td>
                                                    <td class="d-none d-md-inline-block">2595 Pearlman Avenue Sudbury,
                                                        MA 01776 </td>
                                                    <td>$3,325</td>
                                                    <td class="d-none d-lg-inline-block">
                                                        <i class="zmdi zmdi-star col-amber"></i>
                                                ...
                                                <tr>
                                                    <td>Hospital Name</td>
                                                    <td class="d-none d-md-inline-block">508 Virginia Street Chicago, IL
                                                        60653</td>
                                                    <td>$1,325</td>
                                                    <td class="d-none d-lg-inline-block">
                                                        <i class="zmdi zmdi-star col-amber"></i>
                                                ...
                                                <tr>
                                                    <td>Hospital Name</td>
                                                    <td class="d-none d-md-inline-block">1516 Holt Street West Palm
                                                        Beach, FL 33401</td>
                                                    <td>$2,325</td>
                                                    <td class="d-none d-lg-inline-block">
                                                        <i class="zmdi zmdi-star col-amber"></i>
